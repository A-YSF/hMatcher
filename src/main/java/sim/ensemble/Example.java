package sim.ensemble;

import sim.SimScore;
import utils.KnownSim;
 ...
 * 1. The example corresponds to a call to {@link sim.SimilarityMetric#similarity}.
 * 2. The example corresponds to a call to {@link sim.SimilarityMetric#mostSimilar} and the
